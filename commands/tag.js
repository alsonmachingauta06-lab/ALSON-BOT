    ...
    try {
        ...
        if (replyMessage) {
            ...
            if (replyMessage.imageMessage) {
                ...
                messageContent = {
                    image: { url: filePath },
                    caption: messageText || replyMessage.imageMessage.caption || '*Copyright AlsonMachingauta 2025*',
            ...
            // Handle video messages
                ...
                messageContent = {
                    video: { url: filePath },
                    caption: messageText || replyMessage.videoMessage.caption || '*Copyright AlsonMachingauta 2025*',
                    mentions: mentionedJidList
                };
            }
            ...
            // Handle document messages
                ...
                messageContent = {
                    ...
                    caption: messageText || '*Copyright AlsonMachingauta 2025*',
                    mentions: mentionedJidList
                };
            }
